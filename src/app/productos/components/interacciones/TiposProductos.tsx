...
export default function TiposProductos () {
    ...
    return (
        <div className="w-full h-[22%] bg-blue-600">
            <div ref={menuRef} className="relative">
                <div onClick={() => setIsOpen(!isOpen)} className="hover:text-gray-800 absolute cursor-pointer z-2 font-lekton font-semibold text-gray-700 flex justify-center items-center mt-3">
                <div>
                    Tipos
                </div>
                <div>
